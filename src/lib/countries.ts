// ISO-3166 alpha-2 country list — single source for the signup country dropdown
// and any country display. Codes are uppercase, matching x-vercel-ip-country.
...
/** Full country name for an ISO-2 code, or the code itself if unknown. */
export function countryName(code: string | null | undefined): string {
  if (!code) return "";
  return BY_CODE.get(code.toUpperCase()) ?? code.toUpperCase();
}

/** Whether an ISO-2 code is in the list (case-insensitive). */
